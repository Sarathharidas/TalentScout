...
export const Route = createFileRoute("/club")({
  head: () => ({
    meta: [
      { title: "Spotrial for Clubs — Coming Soon" },
      {
        name: "description",
        content:
          "Discover talent, manage your roster, and run your club operations on Spotrial.",
      },
      { property: "og:title", content: "Spotrial for Clubs — Coming Soon" },
      {
        property: "og:description",
        content: "The professional network for football clubs in India.",
      },
    ],
  }),
  component: ClubComingSoon,
});

function ClubComingSoon() {
  return (
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center justify-center px-6 pb-32 pt-20 text-center md:px-10 md:pt-32">
          <p className="font-mono text-xs uppercase tracking-[0.3em] text-accent">
            For the clubs that build the future
          </p>
          ...
          <p className="mt-8 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            Scout verified talent across India, manage your squad and academy pipelines, and run your club operations with data-driven insights. The future of Indian football starts here.
          </p>
