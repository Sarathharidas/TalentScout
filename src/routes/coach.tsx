...
export const Route = createFileRoute("/coach")({
  head: () => ({
    meta: [
      { title: "Spotrial for Coaches — Coming Soon" },
      {
        name: "description",
        content:
          "Build your coaching portfolio, manage your squad, and connect with clubs and scouts on Spotrial.",
      },
      { property: "og:title", content: "Spotrial for Coaches — Coming Soon" },
      {
        property: "og:description",
        content: "The professional network for football coaches in India.",
      },
    ],
  }),
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center justify-center px-6 pb-32 pt-20 text-center md:px-10 md:pt-32">
          <p className="font-mono text-xs uppercase tracking-[0.3em] text-accent">
            For the coaches who shape the game
          </p>
          ...
          <p className="mt-8 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            Build your verified coaching portfolio, showcase your tactics and achievements, manage your squad, and get discovered by clubs looking for the next great mind on the touchline.
          </p>
